...
import type { NumberedStep } from '../../data/types'
...
export default function WhatWeCanDo({ items, image }: { items: NumberedStep[]; image?: string }) {
      ...
      <div className="wwcd-shell">
        <div className="wwcd-main">
          ...
          <div className="wwcd-list">
            {items.map((item: NumberedStep, index: number) => {
