...
import type { DataSolutionsConfig, TitledItem } from '../../data/types'
...
export default function DataWhatWeDeliver({ data }: { data: DataSolutionsConfig['whatWeDeliver'] }) {
    ...
    <section className="ds-deliver" aria-label={data.heading}>
      <div className="ds-deliver-inner">
        ...
        <div className="ds-deliver-grid">
          {data.features.map((feature: TitledItem, index: number) => {
